    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSel ? [BoxShadow(color: color.withValues(alpha: 0.4), blurRadius: 8, offset: const Offset(0, 2))] : null,
        ),
        alignment: Alignment.center,
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: selected == 'NC' ? kDpeColors['NC']! : kDpeColors['NC']!.withValues(alpha: 0.15),
                ...
                children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: colors[i],
                      border: isSel ? Border.all(color: kCharcoal, width: 2.5) : null,
                      boxShadow: isSel ? [BoxShadow(color: colors[i].withValues(alpha: 0.3), blurRadius: 8)] : null,
                    ),
                  ),
