                ...
                Padding(
                  ...
                  child: Row(children: [
                    Container(
                      width: 32, height: 32,
                      decoration: BoxDecoration(
                        color: (_e.chargesCopro > 2000 ? kRed : kGrey).withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(8),
                      ),
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: on ? kGreen.withValues(alpha: 0.3) : Colors.transparent, width: 2),
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(children: [
          Container(
            width: 32, height: 32,
            decoration: BoxDecoration(
              color: (value ? kGreen : kGrey).withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(8),
            ),
